...
2. **MPPI sampling-based control** - 27종 C++ MPPI 플러그인 + 9종 Python MPPI + GPU 가속 (JAX)
3. **ROS2 nav2 integration** - 27종 C++ 플러그인 + 4종 모션 모델 + 5단계 Safety Stack
...
├── HaltonMPPIControllerPlugin      ── Halton 저불일치 시퀀스 (MDPI Drones 2026)
│
│  고급 최적화 변형:
...
├── FeedbackMPPIControllerPlugin    ── Riccati 시변 피드백 게인 K_t (RA-L 2026)
│
│  안전성(safety) 스택 (5단계):
...
| 10 | Halton-MPPI | Halton 저불일치 시퀀스 (MDPI Drones 2026) | All |
| 11 | iLQR-MPPI | iLQR warm-start + MPPI | DiffDrive, Ackermann |
| 12 | CS-MPPI | Covariance Steering (CoVO-MPC, CoRL 2023) | All |
| 13 | π-MPPI | ADMM QP 투영 (RA-L 2025) | All |
| 14 | SVMPC | Stein Variational MPC | All |
| 15 | SVG-MPPI | Guide SVGD + follower (ICRA 2024) | All |
| 16 | Tube-MPPI | Nominal/actual 분리 + 피드백 | DiffDrive |
| 17 | Feedback-MPPI | Riccati 시변 게인 K_t (RA-L 2026) | All |
| 18 | Shield-MPPI | per-step CBF 투영 | All |
| 19 | Adaptive Shield | 거리/속도 적응 α | All |
| 20 | CLF-CBF-QP | Ames (2019) 통합 안전 필터 | All |
| 21 | Predictive Safety | N-step CBF 투영 | All |
...
ros2 launch mpc_controller_ros2 mppi_ros2_control_nav2.launch.py controller:=halton
ros2 launch mpc_controller_ros2 mppi_ros2_control_nav2.launch.py controller:=feedback
...
| test_halton_mppi | 15 | Halton-MPPI |
| test_feedback_mppi | 15 | Feedback-MPPI |
