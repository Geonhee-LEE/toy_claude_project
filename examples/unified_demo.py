...
Examples:
  ...
  %(prog)s --model swerve --trajectory holonomic --live
    ...
    if args.trajectory == "circle":
        ...
        title = f"{args.model.title()} Drive: Circle"
        ...
        title = f"{args.model.title()} Drive: Figure-8"
        ...
        title = f"{args.model.title()} Drive: Sinusoidal"
        ...
        initial_state = np.array([0.0, 0.0, 0.0])
        title = f"{args.model.title()} Drive: Straight Line"
